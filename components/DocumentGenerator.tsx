...
export const DocumentGenerator: React.FC<Props> = ({ documentType, onComplete, onCancel }) => {
  ...
  useEffect(() => {
    if (contentEndRef.current && currentStep === 'preview') {
  ...
  const generatePreview = () => {
    const content = generateTemplateDraft(documentType, formData, region);
              ...
              <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-6 mb-8 flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-700/80">
                        Please provide accurate details below. We will generate a draft based on {region} standards.
                    </p>
                  </div>
              </div>
            ...
            <div className="flex flex-col h-[700px] animate-fade-in-up">
              ...
              <div className="flex justify-between items-center mt-8">
                <button 
                  ...
                  className="px-6 py-3 text-slate-600 hover:text-slate-900 font-medium flex items-center transition-colors border border-slate-200 rounded-lg hover:bg-slate-50"
                >
          ...
          {currentStep === 'payment' && (
            <div className="max-w-lg mx-auto py-8 animate-fade-in-up">
              <div className="text-center mb-10">
                ...
                <p className="text-slate-500 mt-2">Unlock your legally binding document instantly.</p>
              </div>
